package JavaConstructs.FileReadingAndWriting;
import java.io.File;
...
public class FileReadingAndWriting {
    ...
    public static void main(String[] args) {
        try {
            File filePath = new File("src/JavaConstructs/FileReadingAndWriting/scores.txt");
            ...
            File filePath2 = new File("src/JavaConstructs/FileReadingAndWriting/players.txt");
