...
public class DayOfTheYearFaster {
    ...
    public static void main(String[] args) {
        DayOfTheYearFaster dayOfTheYear = new DayOfTheYearFaster();
    ...
    public int dayOfYear(String date) {
        ...
        // Let cumulativeDaysInYear = days passed in the current year so far, at the start of each month.
        // e.g., cumulativeDaysInYear[0] = 0, cumulativeDaysInYear[1] = 31, cumulativeDaysInYear[2] = 59, etc.
        int[] cumulativeDaysInYear = getCumulativeDaysInYear(year);

        // Calculate the day of the year.
        return cumulativeDaysInYear[month - 1] + day;
    }

    private int[] getCumulativeDaysInYear(int year) {
        if (isLeapYear(year)) {
            return new int[] {0, 31, 60, 91, 121, 152, 182, 213, 244, 274, 305, 335};
        } else {  // !isLeapYear(year)
            return new int[] {0, 31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 334};
        }
    }
