package InterviewProblems.Strings.LongerContiguousSegmentsOfOnesThanZeros.RefactoredSolution;
...
public class CheckZeroOnes {
    ...
    public boolean checkZeroOnes(String s) {
        ...
        for (int i = 0; i < s.length(); i++) {
            ...
            if (previousCharacter == '0' && currentCharacter == '0') {
                currentContiguousZeroesLength++;
            } else if (previousCharacter == '1' && currentCharacter == '0') {
            ...
            } else if (previousCharacter == '\0' && currentCharacter == '0') {
                currentContiguousZeroesLength++;  // the first character is a '0'.
            } else if (previousCharacter == '0' && currentCharacter == '1') {
            ...
            } else if (previousCharacter == '1' && currentCharacter == '1') {
                currentContiguousOnesLength++;
            } else {  // previousCharacter == '\0' && currentCharacter == '1'
