package InterviewProblems.IterativeSolutions.NthTribonacciNumber;
...
public class NthTribonacciNumber {
    ...
    // Space: O(1)
    // --> We use an array to store the last 3 tribonacci numbers in the tribonacci sequence.
    ...
    public int tribonacci(int n) {
        ...
        int[] tribonacciNumbers = new int[3];
        tribonacciNumbers[0] = 0;
        tribonacciNumbers[1] = 1;
        tribonacciNumbers[2] = 1;
        for (int i = 3; i <= n; i++) {
            int nextTribonacciNumber = tribonacciNumbers[0] + tribonacciNumbers[1] + tribonacciNumbers[2];
            tribonacciNumbers[0] = tribonacciNumbers[1];
            tribonacciNumbers[1] = tribonacciNumbers[2];
            tribonacciNumbers[2] = nextTribonacciNumber;
        }
        return tribonacciNumbers[2];
    }
}
