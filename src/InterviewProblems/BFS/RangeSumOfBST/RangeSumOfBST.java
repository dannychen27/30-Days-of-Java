package InterviewProblems.BFS.RangeSumOfBST;
...
public class RangeSumOfBST {
    ...
    public static void main(String[] args) {
        ...
        // TODO: Try this problem again using recursive DFS.
    }
    ...
    public int rangeSumBST(BinaryTree root, int low, int high) {
        ...
        while (!queue.isEmpty()) {
            ...
            if (currentNode.value >= low && currentNode.value <= high) {
                rangeSum += currentNode.value;
            }

            if (currentNode.leftChild != null && currentNode.value > low) {
                queue.add(currentNode.leftChild);
            }

            if (currentNode.rightChild != null && currentNode.value < high) {
