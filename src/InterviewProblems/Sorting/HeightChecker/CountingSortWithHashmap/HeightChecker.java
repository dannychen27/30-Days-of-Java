package InterviewProblems.Sorting.HeightChecker.CountingSortWithHashmap;
...
public class HeightChecker {
    ...
    private int[] countingSort(int[] array) {
        ...
        for (int num : numsToFrequencies.keySet()) {
            while (numsToFrequencies.get(num) > 0) {
                sortedArray[index] = num;
                numsToFrequencies.put(num, numsToFrequencies.get(num) - 1);
                index++;
            }
        }
        return sortedArray;
