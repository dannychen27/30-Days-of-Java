package InterviewProblems.Sorting.HeightChecker.ComparisonBasedSorting;
...
public class HeightChecker {
    ...
    //
    // Time: O(n log n)
    // --> O(n log n) for sorting a copy of the heights array.
    // Space: O(n)
    // --> O(1) or O(n) depending on the choice of sorting algorithm.
    // --> O(n) for storing a copy of the heights array.
    // --> O(1) for storing the variable numIncorrectHeights.
