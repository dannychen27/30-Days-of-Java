...
public class MaximumDepthOfBinaryTreeIterativeBFS {

    public static void main(String[] args) {
        MaximumDepthOfBinaryTreeIterativeBFS maximumDepthOfBinaryTreeIterativeBFS = new MaximumDepthOfBinaryTreeIterativeBFS();
        ...
        System.out.println(maximumDepthOfBinaryTreeIterativeBFS.maxDepth(root));  // 3
        ...
        System.out.println(maximumDepthOfBinaryTreeIterativeBFS.maxDepth(root2));  // 4
        ...
        System.out.println(maximumDepthOfBinaryTreeIterativeBFS.maxDepth(root3));  // 4
    }
