package InterviewProblems.TwoPointers.FindIntersectionOfTwoLinkedLists.MostSpaceEfficient;
...
public class IntersectionOfTwoLinkedLists {
    ...
    // Space: O(1)
    // --> We must store the pointers to the current positions of the two linked lists.
    ...
    public Node<Integer> getIntersectionNode(Node<Integer> headA, Node<Integer> headB) {
        // Travel to the end of one linked list, and begin at the other linked list.
        // Keep traversing both linked lists until you either reach the end of both linked lists,
        // or you find the intersection node of the two linked lists.
        ...
        return nodeA;  // nodeA == nodeB or nodeA == nodeB == null
    }
}
