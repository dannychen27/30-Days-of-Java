...
public class ParkingSystem {
    ...
    private int numSlotsForBigCars;
    private int numSlotsForMediumCars;
    private int numSlotsForSmallCars;
    ...
    public ParkingSystem(int big, int medium, int small) {
        numSlotsForBigCars = big;
        numSlotsForMediumCars = medium;
        numSlotsForSmallCars = small;
    }
    ...
    public boolean addCar(int carType) {
        if (carType == 1) {
            ...
            if (numSlotsForMediumCars > 0) {
                numSlotsForMediumCars--;
                return true;
            } else {
                return false;
            }
        } else { // (carType == 3)
            if (numSlotsForSmallCars > 0) {
                numSlotsForSmallCars--;
                return true;
            } else {
                return false;
            }
