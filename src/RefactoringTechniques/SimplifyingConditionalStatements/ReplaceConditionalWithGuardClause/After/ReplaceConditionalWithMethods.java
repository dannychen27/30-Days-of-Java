package RefactoringTechniques.SimplifyingConditionalStatements.ReplaceConditionalWithGuardClause.After;
...
class ReplaceConditionalWithMethods {
    ...
    public static void main(String[] args) {
        ...
        for (int bag = 0; bag < bagWeights.length; bag++) {
            ...
            if (bagWeights[bag] >= 50 && bagWeights[bag] <= 70) {
                bagFees += bag50To70lbs(bag);
            }

            if (bagWeights[bag] > 70) {
                bagFees += 200;
            }
        }
