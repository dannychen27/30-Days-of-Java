...
public class DoublyCircularLinkedList {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(doublyCircularLinkedList);  // EMPTY LIST

        doublyCircularLinkedList.insert(1, 0);
        System.out.println(doublyCircularLinkedList);  // 1

        doublyCircularLinkedList.insert(2, 0);
        System.out.println(doublyCircularLinkedList);  // 2 NEXT PREVIOUS 1

        doublyCircularLinkedList.insert(3, 1);
        System.out.println(doublyCircularLinkedList);  // 2 NEXT PREVIOUS 3 NEXT PREVIOUS 1

        doublyCircularLinkedList.insert(4, 3);
        System.out.println(doublyCircularLinkedList);  // 2 NEXT PREVIOUS 3 NEXT PREVIOUS 1 NEXT PREVIOUS 4

        doublyCircularLinkedList.pop(0);
        System.out.println(doublyCircularLinkedList);  // 3 NEXT PREVIOUS 1 NEXT PREVIOUS 4

        doublyCircularLinkedList.pop(1);
        System.out.println(doublyCircularLinkedList);  // 3 NEXT PREVIOUS 4

        doublyCircularLinkedList.pop(1);
        System.out.println(doublyCircularLinkedList);  // 3
        ...
        doublyCircularLinkedList.insert(5,0);
        System.out.println(doublyCircularLinkedList);  // 5

        doublyCircularLinkedList.insert(4,0);
        System.out.println(doublyCircularLinkedList);  // 4 NEXT PREVIOUS 5

        doublyCircularLinkedList.insert(3,0);
        System.out.println(doublyCircularLinkedList);  // 3 NEXT PREVIOUS 4 NEXT PREVIOUS 5

        doublyCircularLinkedList.insert(2,0);
        System.out.println(doublyCircularLinkedList);  // 2 NEXT PREVIOUS 3 NEXT PREVIOUS 4 NEXT PREVIOUS 5

        doublyCircularLinkedList.insert(1,0);
        System.out.println(doublyCircularLinkedList);  // 1 NEXT PREVIOUS 2 NEXT PREVIOUS 3 NEXT PREVIOUS 4 NEXT PREVIOUS 5

        doublyCircularLinkedList.insert(0,3);
        System.out.println(doublyCircularLinkedList);  // 1 NEXT PREVIOUS 2 NEXT PREVIOUS 3 NEXT PREVIOUS 0 NEXT PREVIOUS 4 NEXT PREVIOUS 5
    }
}
